#1 A company wants to evaluate customer satisfaction with its new product. A random sample of 200 customers was 
#selected from Store A, and a random sample of 150 customers was selected from Store B.In Store A, 120 
#out of 200 customers expressed satisfaction with the product. In Store B, 90 out of 150 customers expressed 
#satisfaction with the product. At a 5% significance level, calculate the confidence intervals for the proportion 
#of satisfied customers in the store A.
...
#2
#A supermarket chain tracks its quarterly profits (in thousands of euros) between 2018 and 2022. The data is shown 
...
#4
#Get the random component of December 2002 from the following time series of miles travelled per month from 
#1992 to 2018:
